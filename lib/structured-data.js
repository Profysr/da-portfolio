...
export function generatePersonSchema() {
  ...
  return {
    ...
    url: typeof window !== "undefined" ? window.location.origin : "https://da-portfolio.dev",
...
export function generateWebSiteSchema() {
  return {
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: `${typeof window !== "undefined" ? window.location.origin : "https://da-portfolio.dev"}/#projects?q={search_term_string}`,
      },
...
export function generateBlogPostingSchema(post) {
  return {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${typeof window !== "undefined" ? window.location.origin : "https://da-portfolio.dev"}/writing/${post.slug}`,
    },

...
/*
 * JournalEntry interface — DEMO ONLY (commented out per Rule #14)
 * Remove or adapt when integrating for real writing navigation.
 */
...
// JournalNavigationProps — DEMO ONLY (commented out per Rule #14)
...
export function JournalNavigation({ entries, initialIndex = 0, onEntryChange }) {
  ...
  return (
    <div className={cn("flex min-h-full w-full flex-col items-center justify-center p-6 transition-colors duration-500")}>
      <div className={cn(
        "border-border bg-muted relative flex h-85 w-full max-w-90 overflow-hidden rounded-lg border shadow-sm transition-colors duration-300 select-none"
      )}>
        <div className={cn(
          "border-border bg-background relative z-10 m-1 flex w-13.5 flex-col items-center justify-center overflow-hidden rounded-lg border transition-colors duration-300"
        )}>
              ...
              {entries.map((entry, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className={cn(
                      "flex h-9.25 w-9.25 shrink-0 items-center justify-center rounded-lg text-[16px] font-bold transition-colors",
                      isActive
